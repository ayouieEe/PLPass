...
export const eventBaseSchema = z
  .object({
    ...
    numberOfPax: z
      .number({ invalid_type_error: "No. of Pax is required" })
      .int("No. of Pax must be a whole number")
      .min(1, "No. of Pax must be at least 1")
      .nullable()
      .optional()
      .refine((value) => value !== null && value !== undefined, {
        message: "No. of Pax is required"
      }),
    ...
    resourceUrl: z
      ...
      .trim()
      .optional()
      .refine((value) => !value || /^https:\/\//.test(value), "Resource Link must use HTTPS.")
  })

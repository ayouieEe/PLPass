...
export function QRCheckoutPanel({ enabled, disabled, onToggle, onSimulate }: QRCheckoutPanelProps) {
  return (
    <section className="rounded-lg border bg-surface p-4" aria-label="QR check-out simulation">

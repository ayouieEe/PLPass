...
export const studentFixtures: Student[] = Array.from({ length: 12 }, (_, index) => {
  ...
  return {
    ...
    fullName: `Student ${String(number).padStart(2, "0")}`,
    formattedName: `Student ${String(number).padStart(2, "0")}`,
    email: `student.${number}@plpass.test`,
...
export const eventFixtures: Event[] = (() => {
  ...
  return [
    { id: "event-1", code: "EVT-2026-001", organizerId: "organizer-1", departmentId: "dept-ccs", category: "Career Development", title: "CCS Orientation", venue: "PLP Pasig Gymnasium", startsAt: `${todayDateStr}T00:00:00.000Z`, endsAt: `${todayDateStr}T04:00:00.000Z`, status: "pending" },
    { id: "event-2", code: "EVT-2026-002", organizerId: "organizer-2", departmentId: "dept-cba", category: "Skills Training", title: "Business Forum", venue: "PLP Multi-Purpose Laboratory", startsAt: `${todayDateStr}T05:00:00.000Z`, endsAt: `${todayDateStr}T09:00:00.000Z`, status: "pending" },
    { id: "event-3", code: "EVT-2026-003", organizerId: "organizer-1", departmentId: "dept-ccs", category: "General Assembly", title: "PLP Student General Assembly", venue: "PLP Pasig Auditorium", startsAt: "2026-03-05T01:00:00.000Z", endsAt: "2026-03-05T03:00:00.000Z", status: "pending" },
    { id: "event-4", code: "EVT-2026-004", organizerId: "organizer-2", departmentId: "dept-ccs", category: "Skills Training", title: "PLP Tech & Leadership Simulation Day", venue: "PLP AVR Auditorium", startsAt: "2026-03-19T00:30:00.000Z", endsAt: "2026-03-19T07:30:00.000Z", status: "pending" },
    { id: "event-5", code: "EVT-2026-005", organizerId: "organizer-1", departmentId: "dept-cte", category: "Seminar", title: "PLP Campus Sustainability Series", venue: "PLP Multi-Purpose Hall", startsAt: "2026-04-02T05:30:00.000Z", endsAt: "2026-04-02T08:00:00.000Z", status: "pending" },
    { id: "event-6", code: "EVT-2026-006", organizerId: "organizer-1", departmentId: "dept-hm", category: "Competition", title: "PLP Inter-College Skills & Talent Showcase", venue: "PLP Main Activity Center", startsAt: "2026-04-18T01:00:00.000Z", endsAt: "2026-04-18T08:00:00.000Z", status: "pending" }
  ];
})().map((event) => ({
  ...event,
...
export const systemSettingsFixture: SystemSettings = {
  ...
  notificationEventsEnabled: true,

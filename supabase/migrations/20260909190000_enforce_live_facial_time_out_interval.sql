...
-- Keep live facial check-out consistent with the session finalizer and the
-- local SQLite recorder.  Reject a too-early capture at the point of capture
-- rather than allowing it to surface as an End Session failure.

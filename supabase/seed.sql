...
DO $$
DECLARE
  v_organizer_user_id uuid := '11111111-1111-1111-1111-111111111111';
  v_student_user_id uuid := '22222222-2222-2222-2222-222222222222';
  v_dept_id uuid := '33333333-3333-3333-3333-333333333333';
BEGIN

  -- Create Organizer User in auth.users
  INSERT INTO auth.users (id, instance_id, aud, role, email, encrypted_password, email_confirmed_at, recovery_sent_at, last_sign_in_at, raw_app_meta_data, raw_user_meta_data, created_at, updated_at, confirmation_token, email_change, email_change_token_new, recovery_token)
  VALUES (v_organizer_user_id, '00000000-0000-0000-0000-000000000000', 'authenticated', 'authenticated', 'organizer@plpass.edu.ph', crypt('password123', gen_salt('bf')), now(), now(), now(), '{"provider":"email","providers":["email"]}', '{}', now(), now(), '', '', '', '');
  
  INSERT INTO auth.identities (id, user_id, provider_id, identity_data, provider, last_sign_in_at, created_at, updated_at)
  VALUES (v_organizer_user_id, v_organizer_user_id, v_organizer_user_id::text, json_build_object('sub', v_organizer_user_id, 'email', 'organizer@plpass.edu.ph'), 'email', now(), now(), now());

  -- Create Student User in auth.users
  INSERT INTO auth.users (id, instance_id, aud, role, email, encrypted_password, email_confirmed_at, recovery_sent_at, last_sign_in_at, raw_app_meta_data, raw_user_meta_data, created_at, updated_at, confirmation_token, email_change, email_change_token_new, recovery_token)
  VALUES (v_student_user_id, '00000000-0000-0000-0000-000000000000', 'authenticated', 'authenticated', 'balbacal_chrishamazel@plpass.edu.ph', crypt('password123', gen_salt('bf')), now(), now(), now(), '{"provider":"email","providers":["email"]}', '{}', now(), now(), '', '', '', '');
  
  INSERT INTO auth.identities (id, user_id, provider_id, identity_data, provider, last_sign_in_at, created_at, updated_at)
  VALUES (v_student_user_id, v_student_user_id, v_student_user_id::text, json_build_object('sub', v_student_user_id, 'email', 'balbacal_chrishamazel@plpass.edu.ph'), 'email', now(), now(), now());

  -- Create Department
  INSERT INTO public.departments (id, department_code, department_name)
  VALUES (v_dept_id, 'TEST-DEPT', 'Test Department')
  ON CONFLICT (id) DO NOTHING;
  
  -- Create Program
  INSERT INTO public.programs (id, department_id, program_code, program_name)
  VALUES ('66666666-6666-6666-6666-666666666666', v_dept_id, 'TEST-PROG', 'Test Program')
  ON CONFLICT DO NOTHING;

  -- Create Section
  INSERT INTO public.sections (id, program_id, section_name, year_level, academic_year, semester)
  VALUES ('77777777-7777-7777-7777-777777777777', '66666666-6666-6666-6666-666666666666', 'TEST-SEC', 1, '2026-2027', '1st Semester')
  ON CONFLICT DO NOTHING;
  ...
  -- Create Student
  INSERT INTO public.students (id, profile_id, student_id, department_id, program_id, section_id, year_level, student_status)
  VALUES ('55555555-5555-5555-5555-555555555555', v_student_user_id, '23-00226', v_dept_id, '66666666-6666-6666-6666-666666666666', '77777777-7777-7777-7777-777777777777', 1, 'enrolled')
  ON CONFLICT (id) DO NOTHING;

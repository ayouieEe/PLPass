...
revoke all on function public.submit_late_reason(uuid, text) from public, anon;
grant execute on function public.submit_late_reason(uuid, text) to authenticated;
